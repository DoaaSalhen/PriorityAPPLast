...
namespace Repository.EntityFramework.Migrations
{
    ...
    [Migration("20220222133417_Create-WarehouseOrderHold-table")]
    partial class CreateWarehouseOrderHoldtable
    {
            ...
            modelBuilder.Entity("PriorityApp.Models.Models.WarehouseOrderHold", b =>
                {
                    ...
                    b.HasKey("userId", "PriorityDate", "OrderId");

                    b.HasIndex("OrderId");

                    b.HasIndex("PriorityDate", "userId");
            ...
            modelBuilder.Entity("PriorityApp.Models.Models.WarehouseOrderHold", b =>
                {
                    ...
                    b.HasOne("PriorityApp.Models.Models.Hold", "Hold")
                        .WithMany()
                        .HasForeignKey("PriorityDate", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
